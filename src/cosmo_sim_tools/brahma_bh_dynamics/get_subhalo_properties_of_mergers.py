...
def evaluate(N):
    ...
    if(merger_type==0):
        ...
        subhalo_merger_redshift_after=z_list[subhalo_merger_snap_after==snap_list][0]
        subhalo_merger_redshift_before=z_list[subhalo_merger_snap_before==snap_list][0]
    print(merger_redshift,subhalo_merger_redshift_before)
...
#    print("!!!",min(Redshift_trajectory_primary),max(Redshift_trajectory_primary))
...
#    print("===",min(Redshift_trajectory_secondary),max(Redshift_trajectory_secondary))    
